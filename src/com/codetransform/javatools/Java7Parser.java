// Generated from /Users/montyzukowski/temboo/development/antlr/grammars-v4/java7/Java7.g4 by ANTLR 4.0
package z;
...
public class Java7Parser extends Parser {
	...
	public final PackageDeclarationContext packageDeclaration() throws RecognitionException {
		...
		try {
			...
			setState(215); match(54);
			setState(216); qualifiedIdentifier();
			setState(217); match(77);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final ImportDeclarationContext importDeclaration() throws RecognitionException {
		...
		try {
			...
			if (_la==71) {
				{
				setState(224); match(71);
				setState(225); match(3);
				}
			}

			setState(228); match(77);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
		...
		try {
			...
			case 51:
				...
				if (_la==18 || _la==60) {
					...
					consume();
					setState(445); classOrInterfaceType();
					}
				}
	...
	public final InterfaceMemberDeclContext interfaceMemberDecl() throws RecognitionException {
		...
		try {
			...
			case Identifier:
				enterOuterAlt(_localctx, 1);
				{
				setState(450); interfaceMethodOrFieldDecl();
				}
				break;
			case 5:
				enterOuterAlt(_localctx, 2);
				{
				setState(451); interfaceGenericMethodDecl();
				}
				break;
			case 53:
				enterOuterAlt(_localctx, 3);
				{
				setState(452); match(53);
				setState(453); match(Identifier);
				setState(454); voidInterfaceMethodDeclaratorRest();
				}
				break;
			case 1:
			case 24:
				enterOuterAlt(_localctx, 4);
				{
				setState(455); interfaceDeclaration();
				}
				break;
			case 30:
			case ENUM:
	...
	public final MethodDeclarationContext methodDeclaration() throws RecognitionException {
		...
		try {
			...
			if (_la==27) {
				...
				setState(476); qualifiedIdentifierList();
				}
			}
			...
			case 56:
				{
				setState(479); methodBody();
				}
				break;
			case 77:
				{
				setState(480); match(77);
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final ConstructorDeclarationContext constructorDeclaration() throws RecognitionException {
		...
		try {
			...
			if (_la==27) {
				...
				setState(489); qualifiedIdentifierList();
				}
			}

			setState(492); match(56);
			setState(494);
			switch ( getInterpreter().adaptivePredict(_input,52,_ctx) ) {
			case 1:
				{
				setState(493); explicitConstructorInvocation();
				}
				break;
			}
			setState(499);
	...
	public final InterfaceMethodOrFieldDeclContext interfaceMethodOrFieldDecl() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(508); typeRef();
			setState(509); match(Identifier);
			setState(510); interfaceMethodOrFieldRest();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final InterfaceMethodOrFieldRestContext interfaceMethodOrFieldRest() throws RecognitionException {
		...
		try {
			...
			case 25:
				enterOuterAlt(_localctx, 1);
				{
				setState(512); constantDeclaratorsRest();
				setState(513); match(77);
				}
				break;
			case 45:
				enterOuterAlt(_localctx, 2);
				{
				setState(515); interfaceMethodDeclaratorRest();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final InterfaceMethodDeclaratorRestContext interfaceMethodDeclaratorRest() throws RecognitionException {
		...
		try {
			...
			if (_la==27) {
				{
				setState(526); match(27);
				setState(527); qualifiedIdentifierList();
				}
			}

			setState(530); match(77);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final InterfaceGenericMethodDeclContext interfaceGenericMethodDecl() throws RecognitionException {
		...
		try {
			...
			case Identifier:
				{
				setState(533); typeRef();
				}
				break;
			case 53:
				{
				setState(534); match(53);
				}
				break;
			default:
				throw new NoViableAltException(this);
			...
			setState(538); interfaceMethodDeclaratorRest();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final ConstantDeclaratorContext constantDeclarator() throws RecognitionException {
		...
		try {
			...
			setState(548); constantDeclaratorRest();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final ConstantDeclaratorsRestContext constantDeclaratorsRest() throws RecognitionException {
		...
		try {
			...
			while (_la==42) {
				...
				setState(565); constantDeclarator();
				}
				}
				setState(570);
				_errHandler.sync(this);
	...
	public final ConstantDeclaratorRestContext constantDeclaratorRest() throws RecognitionException {
		...
		try {
			...
			setState(578); match(25);
			setState(579); variableInitializer();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final VariableDeclaratorIdContext variableDeclaratorId() throws RecognitionException {
		...
		try {
			...
			while (_la==4) {
				{
				{
				setState(582); match(4);
				setState(583); match(37);
				}
				}
				setState(588);
				_errHandler.sync(this);
			...
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << 6) | (1L << 7) | (1L << 10) | (1L << 12) | (1L << 14) | (1L << 15) | (1L << 18) | (1L << 26) | (1L << 29) | (1L << 34) | (1L << 35) | (1L << 36) | (1L << 44) | (1L << 45) | (1L << 49) | (1L << 53) | (1L << 56))) != 0) || ((((_la - 65)) & ~0x3f) == 0 && ((1L << (_la - 65)) & ((1L << (65 - 65)) | (1L << (67 - 65)) | (1L << (69 - 65)) | (1L << (72 - 65)) | (1L << (79 - 65)) | (1L << (88 - 65)) | (1L << (HexLiteral - 65)) | (1L << (DecimalLiteral - 65)) | (1L << (OctalLiteral - 65)) | (1L << (BinaryLiteral - 65)) | (1L << (FloatingPointLiteral - 65)) | (1L << (CharacterLiteral - 65)) | (1L << (StringLiteral - 65)) | (1L << (Identifier - 65)))) != 0)) {
				...
				while ( _alt!=2 && _alt!=-1 ) {
					if ( _alt==1 ) {
						...
						setState(596); variableInitializer();
						}
						} 
					}
					setState(601);
	...
	public final ModifierContext modifier() throws RecognitionException {
		...
		try {
			...
			case 62:
				...
				{
				setState(615); match(62);
				}
				break;
			case 58:
				enterOuterAlt(_localctx, 8);
				{
				setState(616); match(58);
				}
				break;
			case 41:
				enterOuterAlt(_localctx, 9);
				{
				setState(617); match(41);
				}
				break;
			case 33:
	...
	public final PackageOrTypeNameContext packageOrTypeName() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(623); qualifiedIdentifier();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final TypeNameContext typeName() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(627); qualifiedIdentifier();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final QualifiedIdentifierListContext qualifiedIdentifierList() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(663); qualifiedIdentifier();
			setState(668);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==42) {
				{
				{
				setState(664); match(42);
				setState(665); qualifiedIdentifier();
				}
				}
				setState(670);
				_errHandler.sync(this);
	...
	public final FormalParameterDeclarationsContext formalParameterDeclarations() throws RecognitionException {
		...
		try {
			...
			setState(683); typeRef();
			setState(684); formalParameterVariables();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final FormalParameterVariablesContext formalParameterVariables() throws RecognitionException {
		...
		try {
			...
			case 55:
				enterOuterAlt(_localctx, 1);
				{
				setState(686); match(55);
				setState(687); variableDeclaratorId();
				}
				break;
			case Identifier:
				enterOuterAlt(_localctx, 2);
				...
				if (_la==42) {
					...
					setState(690); formalParameterDeclarations();
					}
				}
	...
	public final ExplicitConstructorInvocationContext explicitConstructorInvocation() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				if (_la==5) {
					{
					setState(697); nonWildcardTypeArguments();
					}
				}
				...
				consume();
				setState(701); arguments();
				setState(702); match(77);
				}
				break;
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(704); primary();
				setState(705); match(71);
				setState(707);
				_la = _input.LA(1);
				if (_la==5) {
					{
					setState(706); nonWildcardTypeArguments();
					}
				}

				setState(709); match(18);
				setState(710); arguments();
				setState(711); match(77);
				}
				break;
			}
		}
	...
	public final LiteralContext literal() throws RecognitionException {
		...
		try {
			...
			case BinaryLiteral:
				enterOuterAlt(_localctx, 1);
				{
				setState(723); integerLiteral();
				}
				break;
			case FloatingPointLiteral:
				enterOuterAlt(_localctx, 2);
				{
				setState(724); match(FloatingPointLiteral);
				}
				break;
			case CharacterLiteral:
				enterOuterAlt(_localctx, 3);
				{
				setState(725); match(CharacterLiteral);
				}
				break;
			case StringLiteral:
				enterOuterAlt(_localctx, 4);
				{
				setState(726); match(StringLiteral);
				}
				break;
			case 7:
			case 65:
	...
	public final AnnotationContext annotation() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(735); match(24);
			setState(736); annotationName();
			setState(743);
			_la = _input.LA(1);
			if (_la==45) {
				{
				setState(737); match(45);
				setState(740);
				switch ( getInterpreter().adaptivePredict(_input,86,_ctx) ) {
				case 1:
					{
					setState(738); elementValuePairs();
					}
					break;

				case 2:
					{
					setState(739); elementValue();
					}
					break;
				}
	...
	public final ElementValuePairsContext elementValuePairs() throws RecognitionException {
		...
		try {
			...
			while (_la==42) {
				{
				{
				setState(754); match(42);
				setState(755); elementValuePair();
				}
				}
				setState(760);
				_errHandler.sync(this);
	...
	public final ElementValueContext elementValue() throws RecognitionException {
		...
		try {
			...
			case 56:
				enterOuterAlt(_localctx, 3);
				{
				setState(767); elementValueArrayInitializer();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final ElementValueArrayInitializerContext elementValueArrayInitializer() throws RecognitionException {
		...
		try {
			...
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << 6) | (1L << 7) | (1L << 10) | (1L << 12) | (1L << 14) | (1L << 15) | (1L << 18) | (1L << 24) | (1L << 26) | (1L << 29) | (1L << 34) | (1L << 35) | (1L << 36) | (1L << 44) | (1L << 45) | (1L << 49) | (1L << 53) | (1L << 56))) != 0) || ((((_la - 65)) & ~0x3f) == 0 && ((1L << (_la - 65)) & ((1L << (65 - 65)) | (1L << (67 - 65)) | (1L << (69 - 65)) | (1L << (72 - 65)) | (1L << (79 - 65)) | (1L << (88 - 65)) | (1L << (HexLiteral - 65)) | (1L << (DecimalLiteral - 65)) | (1L << (OctalLiteral - 65)) | (1L << (BinaryLiteral - 65)) | (1L << (FloatingPointLiteral - 65)) | (1L << (CharacterLiteral - 65)) | (1L << (StringLiteral - 65)) | (1L << (Identifier - 65)))) != 0)) {
				...
				while ( _alt!=2 && _alt!=-1 ) {
					if ( _alt==1 ) {
						{
						{
						setState(772); match(42);
						setState(773); elementValue();
						}
						} 
					}
					setState(778);
			...
			if (_la==42) {
				{
				setState(781); match(42);
				}
			}

			setState(784); match(13);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final AnnotationTypeDeclarationContext annotationTypeDeclaration() throws RecognitionException {
		...
		try {
			...
			enterOuterAlt(_localctx, 1);
			{
			setState(786); match(24);
			setState(787); match(1);
			...
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << 1) | (1L << 10) | (1L << 11) | (1L << 12) | (1L << 14) | (1L << 15) | (1L << 16) | (1L << 24) | (1L << 30) | (1L << 33) | (1L << 35) | (1L << 36) | (1L << 39) | (1L << 41) | (1L << 49) | (1L << 50) | (1L << 58) | (1L << 62))) != 0) || ((((_la - 66)) & ~0x3f) == 0 && ((1L << (_la - 66)) & ((1L << (66 - 66)) | (1L << (69 - 66)) | (1L << (73 - 66)) | (1L << (76 - 66)) | (1L << (ENUM - 66)) | (1L << (Identifier - 66)))) != 0)) {
				...
				setState(796); annotationTypeElement();
				}
				}
				setState(801);
				_errHandler.sync(this);
	...
	public final AnnotationTypeElementContext annotationTypeElement() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(804); typeRef();
				setState(807);
				switch ( getInterpreter().adaptivePredict(_input,96,_ctx) ) {
				case 1:
					{
					setState(805); annotationMethod();
					}
					break;
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(811); classDeclaration();
				setState(813);
				_la = _input.LA(1);
				if (_la==77) {
					{
					setState(812); match(77);
					}
				}
			...
			case 3:
				enterOuterAlt(_localctx, 3);
				{
				setState(815); normalInterfaceDeclaration();
				setState(817);
				_la = _input.LA(1);
				if (_la==77) {
					{
					setState(816); match(77);
					}
				}
			...
			case 5:
				enterOuterAlt(_localctx, 5);
				{
				setState(823); annotationTypeDeclaration();
				setState(825);
				_la = _input.LA(1);
				if (_la==77) {
					{
	...
	public final AnnotationMethodContext annotationMethod() throws RecognitionException {
		...
		try {
			...
			setState(830); match(45);
			setState(831); match(22);
			setState(833);
			_la = _input.LA(1);
			if (_la==40) {
				{
				setState(832); defaultValue();
				}
			}
	...
	public final LocalVariableDeclarationContext localVariableDeclaration() throws RecognitionException {
		...
		try {
			...
			setState(844); typeRef();
			setState(845); variableDeclarators();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final StatementContext statement() throws RecognitionException {
		...
		try {
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(848); match(ASSERT);
				setState(849); expression(0);
				setState(852);
				_la = _input.LA(1);
				if (_la==46) {
					{
					setState(850); match(46);
					setState(851); expression(0);
					}
				}

				setState(854); match(77);
				}
				break;
			...
			case 4:
				enterOuterAlt(_localctx, 4);
				{
				setState(863); match(74);
				setState(864); match(45);
				setState(865); forControl();
				setState(866); match(22);
			...
			case 6:
				enterOuterAlt(_localctx, 6);
				{
				setState(873); match(19);
				setState(874); statement();
				setState(875); match(43);
			...
			case 8:
				enterOuterAlt(_localctx, 8);
				{
				setState(880); match(84);
				setState(881); parExpression();
				setState(882); switchBlock();
				}
				break;
			...
			case 15:
				...
				{
				setState(908); statementExpression();
				setState(909); match(77);
				}
				break;
			...
			case 16:
				...
				setState(912); match(46);
				setState(913); statement();
				}
				break;
			}
		}
	...
	public final TryStatementContext tryStatement() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(916); match(52);
				setState(917); match(45);
				setState(918); resources();
				setState(919); match(22);
				setState(920); block();
				setState(924);
				_errHandler.sync(this);
				_la = _input.LA(1);
	...
	public final CatchClauseContext catchClause() throws RecognitionException {
		...
		try {
			...
			while (_la==32) {
				{
				{
				setState(957); match(32);
				setState(958); typeName();
				}
				}
				setState(963);
				_errHandler.sync(this);
	...
	public final ResourceContext resource() throws RecognitionException {
		...
		try {
			...
			setState(985); classOrInterfaceType();
		...
		try {
			...
			while ( _alt!=2 && _alt!=-1 ) {
				if ( _alt==1 ) {
					{
					{
					setState(991); switchBlockStatementGroup();
					}
					} 
				}
				setState(996);
	...
	public final SwitchLabelContext switchLabel() throws RecognitionException {
		...
		try {
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(1020); match(17);
				setState(1021); enumConstantName();
				setState(1022); match(46);
				}
				break;
			...
			case 3:
				enterOuterAlt(_localctx, 3);
				{
				setState(1024); match(40);
				setState(1025); match(46);
				}
				break;
			}
		}
	...
	public final ForControlContext forControl() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(1028); enhancedForControl();
				}
				break;
			...
			case 2:
				...
				setState(1036); match(77);
				setState(1038);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << 6) | (1L << 7) | (1L << 10) | (1L << 12) | (1L << 14) | (1L << 15) | (1L << 18) | (1L << 26) | (1L << 29) | (1L << 34) | (1L << 35) | (1L << 36) | (1L << 44) | (1L << 45) | (1L << 49) | (1L << 53))) != 0) || ((((_la - 65)) & ~0x3f) == 0 && ((1L << (_la - 65)) & ((1L << (65 - 65)) | (1L << (67 - 65)) | (1L << (69 - 65)) | (1L << (72 - 65)) | (1L << (79 - 65)) | (1L << (88 - 65)) | (1L << (HexLiteral - 65)) | (1L << (DecimalLiteral - 65)) | (1L << (OctalLiteral - 65)) | (1L << (BinaryLiteral - 65)) | (1L << (FloatingPointLiteral - 65)) | (1L << (CharacterLiteral - 65)) | (1L << (StringLiteral - 65)) | (1L << (Identifier - 65)))) != 0)) {
					{
					setState(1037); forUpdate();
					}
				}
	...
	public final ForInitContext forInit() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(1042); localVariableDeclaration();
				}
				break;
	...
	public final ParExpressionContext parExpression() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1059); match(45);
			setState(1060); expression(0);
			setState(1061); match(22);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final ExpressionContext expression(int _p) throws RecognitionException {
		...
		try {
			...
			case 2:
				...
				consume();
				setState(1079); expression(16);
				}
				break;

			case 3:
				{
				setState(1080); match(45);
				setState(1081); typeRef();
				setState(1082); match(22);
				setState(1083); expression(15);
				}
				break;
			...
			case 5:
				{
				setState(1086); match(29);
				setState(1087); creator();
				}
				break;
			}
			...
			while ( _alt!=2 && _alt!=-1 ) {
				if ( _alt==1 ) {
					...
					case 3:
						...
						case 1:
							{
							setState(1097); match(5);
							setState(1098); match(5);
							}
							break;
						...
						case 2:
							...
							setState(1101); match(81);
							}
							break;

						case 3:
							{
							setState(1102); match(81);
							setState(1103); match(81);
							}
							break;
						}
						setState(1106); expression(12);
						}
						break;
					...
					case 4:
						...
						case 1:
							{
							setState(1108); match(5);
							setState(1109); match(25);
							}
							break;

						case 2:
							{
							setState(1110); match(81);
							setState(1111); match(25);
							}
							break;
					...
					case 6:
						...
						setState(1121); match(2);
						setState(1122); expression(8);
						}
						break;
					...
					case 7:
						...
						setState(1124); match(70);
						setState(1125); expression(7);
						}
						break;
					...
					case 8:
						...
						setState(1127); match(32);
						setState(1128); expression(6);
						}
						break;
					...
					case 9:
						...
						setState(1130); match(78);
						setState(1131); expression(5);
						}
						break;
					...
					case 10:
						...
						setState(1133); match(80);
						setState(1134); expression(4);
						}
						break;
					...
					case 11:
						...
						case 1:
							{
							setState(1136); match(61);
							}
							break;

						case 2:
							{
							setState(1137); match(59);
							}
							break;

						case 3:
							{
							setState(1138); match(38);
							}
							break;

						case 4:
							{
							setState(1139); match(21);
							}
							break;

						case 5:
							{
							setState(1140); match(85);
							}
							break;

						case 6:
							{
							setState(1141); match(48);
							}
							break;

						case 7:
							{
							setState(1142); match(28);
							}
							break;
						...
						case 10:
							{
							setState(1147); match(81);
							setState(1148); match(81);
							setState(1149); match(81);
							setState(1150); match(25);
							}
							break;
						...
						case 11:
							...
							setState(1153); match(25);
							}
							break;

						case 12:
							{
							setState(1154); match(83);
							}
							break;
						}
						setState(1157); expression(1);
						}
						break;
					...
					case 12:
						...
						setState(1159); match(51);
						setState(1160); expression(0);
						setState(1161); match(46);
						setState(1162); expression(3);
						}
						break;
					...
					case 14:
						...
						setState(1168); match(71);
						setState(1169); match(79);
						}
						break;
					...
					case 15:
						...
						setState(1171); match(71);
						setState(1172); match(18);
						setState(1173); match(45);
						setState(1175);
						_la = _input.LA(1);
						if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << 6) | (1L << 7) | (1L << 10) | (1L << 12) | (1L << 14) | (1L << 15) | (1L << 18) | (1L << 26) | (1L << 29) | (1L << 34) | (1L << 35) | (1L << 36) | (1L << 44) | (1L << 45) | (1L << 49) | (1L << 53))) != 0) || ((((_la - 65)) & ~0x3f) == 0 && ((1L << (_la - 65)) & ((1L << (65 - 65)) | (1L << (67 - 65)) | (1L << (69 - 65)) | (1L << (72 - 65)) | (1L << (79 - 65)) | (1L << (88 - 65)) | (1L << (HexLiteral - 65)) | (1L << (DecimalLiteral - 65)) | (1L << (OctalLiteral - 65)) | (1L << (BinaryLiteral - 65)) | (1L << (FloatingPointLiteral - 65)) | (1L << (CharacterLiteral - 65)) | (1L << (StringLiteral - 65)) | (1L << (Identifier - 65)))) != 0)) {
							{
					...
					case 16:
						...
						setState(1179); match(71);
						setState(1180); match(29);
						setState(1181); match(Identifier);
						setState(1182); match(45);
						setState(1184);
						_la = _input.LA(1);
						if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << 6) | (1L << 7) | (1L << 10) | (1L << 12) | (1L << 14) | (1L << 15) | (1L << 18) | (1L << 26) | (1L << 29) | (1L << 34) | (1L << 35) | (1L << 36) | (1L << 44) | (1L << 45) | (1L << 49) | (1L << 53))) != 0) || ((((_la - 65)) & ~0x3f) == 0 && ((1L << (_la - 65)) & ((1L << (65 - 65)) | (1L << (67 - 65)) | (1L << (69 - 65)) | (1L << (72 - 65)) | (1L << (79 - 65)) | (1L << (88 - 65)) | (1L << (HexLiteral - 65)) | (1L << (DecimalLiteral - 65)) | (1L << (OctalLiteral - 65)) | (1L << (BinaryLiteral - 65)) | (1L << (FloatingPointLiteral - 65)) | (1L << (CharacterLiteral - 65)) | (1L << (StringLiteral - 65)) | (1L << (Identifier - 65)))) != 0)) {
							{
					...
					case 17:
						...
						setState(1188); match(71);
						setState(1189); match(18);
						setState(1190); match(71);
					...
					case 19:
						...
						setState(1199); match(4);
						setState(1200); expression(0);
						setState(1201); match(37);
						}
						break;
					...
					case 22:
						...
						setState(1212); match(89);
						setState(1213); typeRef();
						}
						break;
					}
					} 
	...
	public final PrimaryContext primary() throws RecognitionException {
		...
		try {
			...
			case 7:
				enterOuterAlt(_localctx, 7);
				{
				setState(1231); match(53);
				setState(1232); match(71);
				setState(1233); match(30);
				}
				break;
			}
		}
	...
	public final CreatorContext creator() throws RecognitionException {
		...
		try {
			...
			case Identifier:
				...
				case 4:
					{
					setState(1241); arrayCreatorRest();
					}
					break;
				case 45:
					{
					setState(1242); classCreatorRest();
					}
					break;
				default:
					throw new NoViableAltException(this);
	...
	public final CreatedNameContext createdName() throws RecognitionException {
		...
		try {
			...
			case Identifier:
				...
				case 2:
					{
					setState(1250); match(5);
					setState(1251); match(81);
					}
					break;
				}
				setState(1263);
				...
				while (_la==71) {
					...
					case 2:
						{
						setState(1257); match(5);
						setState(1258); match(81);
						}
						break;
					}
					}
	...
	public final InnerCreatorContext innerCreator() throws RecognitionException {
		...
		try {
			...
			case 2:
				{
				setState(1269); match(5);
				setState(1270); match(81);
				}
				break;
			}
	...
	public final ArrayCreatorRestContext arrayCreatorRest() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(1280); match(4);
				setState(1281); match(37);
				setState(1286);
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (_la==4) {
				...
				setState(1289); arrayInitializer();
				}
				break;
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(1290); match(4);
				setState(1291); expression(0);
				setState(1292); match(37);
				setState(1299);
				_errHandler.sync(this);
	...
	public final ClassCreatorRestContext classCreatorRest() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1311); arguments();
			setState(1313);
			switch ( getInterpreter().adaptivePredict(_input,155,_ctx) ) {
			case 1:
				{
				setState(1312); classBody();
				}
				break;
			}
			}
	...
	public final NonWildcardTypeArgumentsContext nonWildcardTypeArguments() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1315); match(5);
			setState(1316); typeList();
			setState(1317); match(81);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
